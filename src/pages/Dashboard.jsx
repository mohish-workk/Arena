...
import { User, Package, CreditCard, Heart, CheckCircle2, QrCode, ArrowRight, History, ShoppingBag } from 'lucide-react';

const Dashboard = () => {
    const [activeTab, setActiveTab] = useState('Rentals');

    const tabs = ['Rentals', 'Listings', 'History'];
    ...
    return (
        <div className="bg-cream min-h-screen pt-12 pb-24">
            <div className="max-w-7xl mx-auto px-8">
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div>
                            <div className="flex items-center gap-3 mb-1">
                                <h1 className="text-3xl font-bold tracking-tight text-secondary">Mohish Padave</h1>
                            ...
                            <p className="text-secondary/40 text-sm font-medium italic">mohish.padave@ves.ac.in</p>
                        </div>
                    </div>
                ...
                <div className="bg-white border border-secondary/5 min-h-[500px] flex flex-col">
                    <div className="flex border-b border-secondary/5">
                        {tabs.map(tab => (
                            <button
                                key={tab}
                                onClick={() => setActiveTab(tab)}
                                className={`flex-grow md:flex-none md:px-12 py-6 text-[10px] font-bold uppercase tracking-[0.2em] transition-all relative ${activeTab === tab
                                    ? 'text-primary'
